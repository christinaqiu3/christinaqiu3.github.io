                ...
                <div className='cards__wrapper'>
                    <ul className='cards__items'>
                        ...
                        <CardItem
                            ...
                            allowing edge splitting, face triangulation, extrusion, and smoothening via Catmull-Clark subdivision.
                            Utilizing a JSON skeleton, performs distance-based skinning for mesh deformation.'
...
'
                    ...
                    <ul className='cards__items'>
                        ...
                        <CardItem
                            src='images/cig.mp4'
                            text='Developed essential 3D character animation, model creation, and camera work with a team of 5 to produce a 3D animation.
'
